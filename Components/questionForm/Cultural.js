        ...
        <SafeAreaView style={styles.mainContainer}>
            <ScrollView>
                ...
                <View style={styles.label}>
                    <Text>Traditional folk medicine</Text>
                </View>
                <TextInput
                    style={styles.input}
                ...
                <View style={styles.label}>
                    <Text>
                        Traditional Cultural heritage, Traditional Food and diet,
                    </Text>
                </View>
                <TextInput
                    multiline
                ...
                <View style={styles.label}>
                    <Text>
                        Folk Dances,Traditional Village festivals,Folk Music and instruments.
                    </Text>
                </View>
                <TextInput
                    multiline
